...
public class newController {
    ...
    private void showExit(){
        new newView(this).exit();
    }
    private void showSearchBookName(){
        new newView(this).searchBookName();
    }
    private void showSearchBookAuthor(){
        new newView(this).searchBookAuthor();
    }
    private void showCurrentList(){
        new newView(this).listBooks(currentBooks);
    }
    ...
    private void showBookInfo(){
        new newView(this).info(currentBook);
    }
    private void showBookEdit(){
        new newView(this).editBook(currentBook);
    }
